...
def save_peft_checkpoint(model, model_path, is_main_process=True):
    ...
    if isinstance(model, FSDP):
        ...
        model.save_pretrained(model_path, is_main_process=is_main_process, state_dict=state_dict)
    else:
        model.save_pretrained(model_path, is_main_process=is_main_process)
