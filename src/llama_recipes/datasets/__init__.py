...
from llama_recipes.datasets.instruct_to_code_dataset import get_preprocessed_instuct2code as get_instuct2code_dataset
from llama_recipes.datasets.shape_to_code_dataset import get_preprocessed_shape2code as get_shape2code_dataset