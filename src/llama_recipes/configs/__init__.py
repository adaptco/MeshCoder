...
from llama_recipes.configs.training_shape2code import train_shape2code_config
from llama_recipes.configs.training_shape_feature_predictor import train_shape_feature_predictor_config
